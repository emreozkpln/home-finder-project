...
const LoginForm = () => {
	...
	return (
		<div className="grid grid-cols-2">
			...
			<div className="px-40 py-8 flex flex-col gap-32">
				<div className="flex flex-col gap-1">
					<div className="text-3xl font-semibold text-[#575A63]">Sign In</div>
					<div className="text-sm text-[#c8c8ca]">Welcome!</div>
					<div className="text-sm text-[#c8c8ca]">You can log in with your e-mail address and password.</div>
				</div>
				<form action={loginAction} className="flex flex-col gap-16">
